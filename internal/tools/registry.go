...
// only ever sees wire names; they must match this. Spec: tools-core.md §3.1, §10.
...
// string substitution (collisions are possible). Spec: §3.1.
...
// ChatTool is the OpenAI function-spec projection (re-derived in Go, NOT ported
// from models/fireworks.ts). Parameters is the raw JSON Schema object.
...
// OpenAITools projection. Unknown ⇒ "" (no such resolution). Spec: §3.1, §14.9.
