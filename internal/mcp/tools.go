...
// expected and ignored. 60 names — keep byte-stable with the reference prose.
...
var DocumentedMcpToolNames = []string{
	...
	"agent.focusPreviousAgent", "agent.launch", "agentSessionHistory.list", "agentSettings.get",
	...
	"forge.getCIStatus", "forge.getIssue", "forge.getPR", "forge.listIssues", "forge.listPRs",
