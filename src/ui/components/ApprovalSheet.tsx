 ...
 * safe choice), states the action / target / risk / reason in plain rows, and
 * stays understandable with color stripped. `V` reveals the raw args.
 */
...
export function ApprovalSheet({
  ...
  return (
    ...
    >
      ...
      <Field label="action" value={req.toolName} />
      <Field label="risk" value={req.risk} />
      <Field label="reason" value={req.summary} />
      {showArgs ? <Field label="args" value={compactArgs(req.args, width - 12)} /> : null}
      <Box marginTop={1}>
